...
Usage::
    ...
    python -m phiacta.cli.reconcile [--dry-run] [--entry-id UUID ...]
...
both Postgres and Forgejo::
    ...
    docker compose exec backend python -m phiacta.cli.reconcile
"""
...
from phiacta.db.session import get_engine, get_session_factory
from phiacta.services.git_service import ForgejoGitService
from phiacta.services.reconciliation import ReconciliationReport, ReconciliationService

logger = logging.getLogger("phiacta.cli.reconcile")
